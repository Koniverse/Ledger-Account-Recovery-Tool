...
import { BasicInputWrapper } from 'types/index';

// eslint-disable-next-line @typescript-eslint/no-explicit-any
export default function useSelectModalInputHelper ({ id, onBlur, onChange, onFocus }: BasicInputWrapper, ref: ForwardedRef<InputRef>): Pick<SelectModalProps<any>, 'onSelect'> {
